...
book = {
    ("xooooo..xxoooo..xoxoxooxxoxxoxooxxoxoxxxxxxoxoxx..xoox....xo.xx.","x"):6,
    ("xxxxxxx.xxooox..xoxoxooxxoxxoxooxxoxoxxxxxxoxoxx..ooox...ooo.xx.","x"):14,
    (".....o..o.oooo..ooooo....oooox...ooooxo.ooooxx....ox......o.....","o"):30,
    (".....o..o.oooo..ooooox...ooooxo..ooooxo.ooooox....oo......o.....","o"):53
}
...
class Strategy:
    ...
    def best_strategy(self, board, player, best_move, running):
        ...
        if running.value:
            ...
            if (board,tokenToPlay) in book:
                best_move.value = book[(board,tokenToPlay)]
            else:
                dotC = board.count(".")
                if dotC<LIMIT_AB:
                    neg = alphabeta(board,player,[],-64,64)
                else:
                    neg = midalphabeta(board,player,[],-math.inf,math.inf,4)
                moveSequence = neg[1]
                best_move.value = moveSequence[0]
